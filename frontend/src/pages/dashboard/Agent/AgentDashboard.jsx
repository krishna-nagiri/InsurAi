...
export default function AgentDashboard() {
  ...
  useEffect(() => {
    ...
    if (storedAgentId && storedAgentName) {
      ...
      // Fetch availability
      axios.get(`${import.meta.env.VITE_API_BASE_URL}/agent/${id}/availability`, axiosConfig)
        .then(res => {
      ...
      let employeeMap = {};
      axios.get(`${import.meta.env.VITE_API_BASE_URL}/auth/employees`, axiosConfig)
        .then(empRes => {
          ...
          // Fetch all queries
          axios.get(`${import.meta.env.VITE_API_BASE_URL}/agent/queries/all/${id}`, axiosConfig)
            .then(res => {
              if (res.data) {
  ...
  const toggleAvailability = async () => {
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_BASE_URL}/agent/availability`, {
        agentId,
        available: newStatus,
      ...
      const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/agent/${agentId}/availability`, axiosConfig);
  ...
  const respondToQuery = async (id, responseText, isUpdate = false) => {
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/agent/queries/respond/${id}`,
